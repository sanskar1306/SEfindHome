            ...
            <div className="col-xl-4 col-lg-4 mb-50">
              <div className="footer-widget">
                ...
                <div className="footer-text">
                  <p>
                    We have created this platform for owners to host their
                    houses so that tourists can get cheap and affordable st.
                  </p>
                </div>
          ...
          <div className="row">
            <div className="col-xl-6 col-lg-6 text-center text-lg-left">
              <div className="copyright-text">
                <p>
                  &copy; 2021 FIND HOME | All Right Reserved | Terms Of Service
                  | Privacy
                </p>
              </div>
            </div>
